  ...
  return (
    <div className="pt-[91px]">
      <div className="container mx-auto px-3">
        <h2 className="text-center text-4xl font-bold py-6">Add Product</h2>
        <form
          onSubmit={handleAddPoduct}
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:space-x-4">
            <label className="form-control w-full">
              ...
              <select className="select select-bordered" name="type">
                <option disabled defaultValue={"Convertible"}></option>
          ...
          <div className="flex flex-col md:flex-row md:space-x-4">
            <label className="form-control w-full">
              ...
              <select className="select select-bordered" name="brand">
                <option disabled defaultValue={"Audi"}></option>
          ...
          <div className="flex flex-col md:flex-row md:space-x-4">
            <label className="form-control w-full">
              ...
              <select className="select select-bordered" name="fuel">
                <option disabled defaultValue={"Diesel"}></option>
            ...
            <label className="form-control w-full">
              ...
              <select className="select select-bordered" name="drive">
                <option disabled defaultValue={"AWD/4WD"}></option>
          ...
          <div className="flex flex-col md:flex-row md:space-x-4">
            <label className="form-control w-full">
              ...
              <select className="select select-bordered" name="colors">
                <option disabled defaultValue={"Black"}></option>
            ...
            <label className="form-control w-full">
              ...
              <select className="select select-bordered " name="doors">
                <option disabled defaultValue={"2-door"}></option>
          ...
          <div className="flex flex-col md:flex-row md:space-x-4">
            <label className="form-control w-full">
              ...
              <select className="select select-bordered " name="cylinders">
                <option disabled defaultValue={"4"}></option>
            ...
            <label className="form-control w-full">
              ...
              <select className="select select-bordered " name="transmission">
                <option disabled defaultValue={"Automatic"}></option>
